...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        out1, cache1 = affine_relu_forward(X.reshape(batch_size, -1), self.params['W1'], self.params['b1'])
        ...
        loss += self.reg * (self.params['W1'] ** 2).sum() * 0.5
        loss += self.reg * (self.params['W2'] ** 2).sum() * 0.5
